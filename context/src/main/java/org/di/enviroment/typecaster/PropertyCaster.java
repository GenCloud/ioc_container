 ...
 */
package org.di.enviroment.typecaster;
...
public class PropertyCaster {
    ...
    public static void cast(Object object, Field field, String value) throws IllegalAccessException, IllegalPropertyException {
        if (!isCastable(field))
