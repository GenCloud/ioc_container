...
/**
 * Inspector for detecting the methods of used annotation {@link PropertyFunction}
 * and check this methods for return type.
 *
 * @author GenCloud
 * @date 11.09.2018
 */
public class EnvironmentInspector implements Inspector<Boolean, Object> {
    @Override
    public Boolean inspect(Object tested) throws Exception {
