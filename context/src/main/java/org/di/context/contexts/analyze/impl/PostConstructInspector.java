...
/**
 * Inspector for detecting methods annotated with PostConstruct
 *
 * @author GenCloud
 * @date 12.09.2018
 * @see javax.annotation.PostConstruct
 */
public class PostConstructInspector implements Inspector<Boolean, Class<?>> {
    @Override
    public Boolean inspect(Class<?> tested) {
