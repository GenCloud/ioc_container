...
/**
 * This is an {@link Future} for {@link Event}. This {@link Future} can be used
 * to receive notifications once an event has been dispatched to all listeners.
 *
 * @param <E> the event type in this future
 * @author GenCloud
 * @date 15.09.2018
 */
public interface EventFuture<E extends Event> extends Future<E> {
    /**
