 ...
 * }</pre>
 * <br />
 * When annotate fields, library will parse property from file and manually cast its value to field bag.
...
public @interface Property {
	 ...
	 */
	String path() default "configs/default_settings.properties";
	 ...
	 * Parametrization is pre-work of readValues and it affects native string values from property file.
