...
import org.di.threads.factory.model.interfaces.AsyncListener;
...
public class AsyncFutureImpl<T> implements AsyncFuture<T> {
     ...
     */
    private List<AsyncListener<T>> listeners = new ArrayList<>();
     ...
     * @param future future
     */
    AsyncFutureImpl(Future<T> future) {
        this.future = future;
    }
    ...
    void notifyListeners() {
        for (AsyncListener<T> listener : listeners) {
            T object = null;
            try {
