...
import org.di.cache.facade.WeakFacade;
 ...
 * @date 16.09.2018
 */
public class WeakReferenceFactory implements ICacheFactory {
    private ICache<MethodInvocation, Object> invocationObjectICache;

    @Override
    public void initialize() throws IoCException {
        invocationObjectICache = install("weak-reference-interface-cache");
    }
